...
pandoc -t markdown --resource-path=./docs/images -o WorldOfWorkflowsUniversity.md ./01_about.md ./02_installation.md ./03_navigation.md ./04_gettingstarted.md
# Create Word Doc
pandoc -t docx --resource-path=./docs/images -o WorldOfWorkflowsUniversity.docx ./01_about.md ./02_installation.md ./03_navigation.md ./04_gettingstarted.md
