...
- Properties
  ...
  - **Method** - The HTTP Method to Use. One of:
    - **Get**
    - **Post**
    - **Put**
    - **Patch**
    ...
    - **Options**
    - **Head**
  - **Content** - The HTTP Content or **Body** to send with the request.
  - **Content Type** - The HTTP Content-Type to send with the request
  - **Read Content** - Check this to read the content of the response
  - **Supported Status Codes** - A list of possible HTTP Status codes that you may wish to handle with this response
- Advanced
