...
<img src="./media/image65.png" style="width:0.3;height:0.3in" />The *Value* can be entered as either **JavaScript**, **Liquid** or **Default** text. Click on the above entry box to switch the type of input you need.
