...
> Version 1.3.491 Released 17 March 2023

## Breaking Changes
The JotForm Parse activity has been deprecated and replaced with the new more functional JSON Data Insert activity.
TaskCreate and Wait Activity has been deprecated and replaced with the new Task Create activity.
## Known Issues
- #2895 - Activity Testing | JSON Data Insert | Can't insert multiple objects
WORKAROUND: Use JSON Data Insert with a single object
- #3228 - Workflow Test is inoperable
WORKAROUND: None
- #3154 - Data Export filename is called 'details-x <timestamp>' - should include the Data Type
WORKAROUND: Rename file after downloading
- #2562 - DataInstanceEditor - no breadcrumbs to take me back to the view of data
WORKAROUND: Use the back button in your browser
- #3090 - Dates are difficult to enter in Add Instance editor - also needs a time
WORKAROUND: None
...
WORKAROUND: None
- #3100 - Task List - Related Object should link to the data object
WORKAROUND: None
- #3101 - Task List - Current User not meaningful
WORKAROUND: Ignore the Field
- #3139 - Cannot start a workflow by naming it <TYPE>_xxx
WORKAROUND: Use the new ObjectInstanceTrigger Activity
- #3143 - Completing a task with another in MyTasks does not display the next task
WORKAROUND: Click on the next task
- #3156 - Delete column - can't if 'in use'
WORKAROUND: None
- #3157 - Unable to rename field 'Manager' to 'Manager-old'
WORKAROUND: None
- #3160 - Import: import fails if an existing type name is entered
WORKAROUND: None
- #3219 - view sorting icon is backwards
WORKAROUND: None
- #3221 - Tasks view in an object instance - status is 'Unavailable' for a new task when the task is in the 'Available Tasks' list
WORKAROUND: As the task is new, there is no status, thus it shows unavailable.
